...
class FLLearningVGG11(object): 
    ...
    def main(self):
        ...
        # client模型
        client_models = [ VGG('VGG11').cuda() for _ in range(self.num_selected)]
        for model in client_models:
